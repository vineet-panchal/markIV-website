  ...
  return (
    <>
      <div className="about-ctr" id="about">
        ...
        <h4 className="about-paragraph" id="paragraph-2">
          I'm a team player with excellent communication skills, and I thrive in
          collaborative environments. I'm proficient in a range of programming
          languages, including Java, Python, and JavaScript. My main focus is to
        ...
        <h4 className="about-paragraph" id="paragraph-4">
          Fun Facts: I made a song once, I can speak three languages, and my parents
          almost named me "Bridge".
        </h4>
        <h4 className="about-paragraph" id="paragraph-5">
          Feel free to reach out to me, or simply just to say Hi!
        </h4>
      </div>
    </>
  )
