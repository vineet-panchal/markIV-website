...
import resume from "../assets/Vineet_Panchal_Resume.pdf";
      ...
      <div className="sidebar-ctr">
        ...
        <div className="contact-ctr">
          <ul className="contact-links">
            ...
            <a href="mailto: vineetpanchal03@gmail.com" target="_blank">
